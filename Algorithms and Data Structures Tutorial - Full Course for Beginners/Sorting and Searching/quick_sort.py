...
numbers = load_numbers('numbers/1000.txt')
sys.setrecursionlimit(10000)

# TODO -> VERY FAST SORTING ALGORITHM
# TODO => TIME COMPLEXITY: O(n2)  // Big O -> Tells us the number of times an operation is performed
