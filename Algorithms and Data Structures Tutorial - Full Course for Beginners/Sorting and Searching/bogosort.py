...
# print(os.getcwd())
# os.chdir('D:\Miro\programs\Python_Projects\Project Advanced May - Sep 2020\Algorithms and Data Structures Tutorial - Full Course for Beginners\Sorting and Searching')
