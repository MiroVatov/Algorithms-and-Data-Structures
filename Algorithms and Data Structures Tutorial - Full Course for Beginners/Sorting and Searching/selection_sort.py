...
numbers = load_numbers('numbers/10000.txt')


# TODO -> SELECTION SORT IS ALSO VERY SLOW ALGORYTHM, BECAUSE IT TRAVERSES THROUGH EACH ELEMENT OF THE UNSORTED ARRAY,
#  SEARCHING FOR THE SMALLEST NUMBER IN THE ARRAY

#  TODO => TIME COMPLEXITY: O(n2)
...
print(f'Algorithm duration: {end_time - start_time}')
